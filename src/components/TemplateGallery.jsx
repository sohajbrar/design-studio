...
export const TEMPLATES = [
  {
    ...
    showBase: false,
    clipDuration: 4,
    textOverlay: { text: 'Your App Name', fontSize: 52, color: '#FFFFFF', posY: -0.45, animation: 'slideFromBottom' },
    musicId: 'f-5',
    preview: {
      gradient: 'linear-gradient(135deg, #1a0a2e 0%, #6020b0 40%, #e04098 70%, #ff8c40 100%)',
      accentColor: '#e04098',
    },
  },
  {
  ...
  },
  {
    ...
    showBase: false,
    clipDuration: 2.5,
    textOverlay: { text: 'Try It Free', fontSize: 52, color: '#FFFFFF', posY: 0.45, animation: 'slideFromTop' },
    musicId: 'f-3',
    preview: {
      gradient: 'linear-gradient(135deg, #00d2e6 0%, #e0f0f5 40%, #e63c96 70%, #50b4ff 100%)',
      accentColor: '#00a8b8',
    },
  },
  {
    ...
    musicId: 'f-11',
    preview: {
      gradient: 'linear-gradient(135deg, #64e6c8 0%, #e8f0e5 30%, #ff9b78 60%, #82d2ff 100%)',
      accentColor: '#2a8a6a',
    },
  },
  {
    ...
    showBase: false,
    clipDuration: 5,
    textOverlay: { text: 'Designed for You', fontSize: 48, color: '#FFFFFF', posY: -0.45, animation: 'slideFromLeft' },
    musicId: 'f-4',
    preview: {
      gradient: 'linear-gradient(135deg, #0a1420 0%, #143c6e 50%, #1e5082 100%)',
      accentColor: '#4a90c8',
    },
  },
  {
  ...
  },
  {
    ...
    name: 'Phone + Laptop',
    description: 'Sweep from phone to laptop',
    category: 'Multi-Device',
    deviceType: 'iphone',
