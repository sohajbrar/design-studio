...
const MUSIC_TRACKS = [
  ...
  { id: 'f-5', name: 'Beautiful, You Are', mood: 'beautiful, inspiring, heartfelt' },
  { id: 'f-6', name: 'Easy To Love', mood: 'smooth, romantic, easygoing' },
  { id: 'f-7', name: 'Good Intentions', mood: 'sincere, uplifting, warm' },
  { id: 'f-8', name: 'Knockout', mood: 'bold, powerful, impactful' },
  { id: 'f-9', name: 'Paint Me Happy', mood: 'joyful, colorful, playful' },
  { id: 'f-10', name: 'Pink Confetti', mood: 'celebratory, festive, light' },
  { id: 'f-11', name: 'Take Me Home', mood: 'nostalgic, soothing, comforting' },
